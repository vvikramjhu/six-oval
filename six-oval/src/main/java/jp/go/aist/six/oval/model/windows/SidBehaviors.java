...
/**
 * The SidBehaviors defines a number of behaviors that allow
 * a more detailed definition of the sid_object being specified.
 *
    ...
    implements OvalObject
{
                    ...
                    )
    {
        ...
        if (!(obj instanceof SidBehaviors)) {
            return false;
        }

        if (super.equals( obj )) {
            SidBehaviors  other = (SidBehaviors)obj;
