...
/**
 * The RegkeyAuditPermissionsBehaviors defines a number of behaviors
 ...
 *             Replaced by the RegkeyAuditPermissions53Behaviors and
...
//                    final RegkeyAuditPermissionsBehaviors obj
//                    )
//    {
...
//        return result;
                    ...
                    )
    {
        ...
        if (!(obj instanceof RegkeyAuditPermissionsBehaviors)) {
            return false;
        }

//        if (super.equals( obj )) {
//            RegkeyAuditPermissionsBehaviors  other = (RegkeyAuditPermissionsBehaviors)obj;
