...
/**
 * The inetlisteningserver510 object is used by an inetlisteningserver510 test
 ...
 */
public class InetListeningServers510Object
    extends SystemObjectType
{
     ...
     * Constructor.
     */
    public InetListeningServers510Object()
    {
        this( null, 0 );
    }
    ...
    {
        if (!(obj instanceof InetListeningServers510Object)) {
            return false;
        }
    ...
    {
        return "inetlisteningservers510_object[" + super.toString()
                        + ", set="              + getSet()
