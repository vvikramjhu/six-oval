...
/**
 * The EntityStatePeTargetMachineType identifies the valid machine targets
    ...
    extends EntityStateStringType
{
     ...
     * Constructor.
     */
    public EntityStatePeTargetMachineType()
    {
    }
...
//    }
    ...
    {
        if (content != null) {
            PeTargetMachineEnumeration.fromValue( content );
        }
                    ...
                    )
    {
        ...
        if (!(obj instanceof EntityStatePeTargetMachineType)) {
            return false;
        }
