 ...
 */
public abstract class AbstractFileAuthBehaviors
extends FileBehaviors
{
     ...
     * Constructor.
     */
    public AbstractFileAuthBehaviors()
    {
    }
    ...
    public static final Boolean includeGroup(
                    final AbstractFileAuthBehaviors obj
                    )
    {
                    ...
                    )
    {
        ...
        if (!(obj instanceof AbstractFileAuthBehaviors)) {
            return false;
        }

        if (super.equals( obj )) {
            AbstractFileAuthBehaviors  other = (AbstractFileAuthBehaviors)obj;
