 ...
 */
public abstract class AbstractAuthBehaviors
    implements OvalObject
{
    ...
    public static final Boolean includeGroup(
                    final AbstractAuthBehaviors obj
                    )
    {
                    ...
                    )
    {
        ...
        if (!(obj instanceof AbstractAuthBehaviors)) {
            return false;
        }

        if (super.equals( obj )) {
            AbstractAuthBehaviors  other = (AbstractAuthBehaviors)obj;
