...
/**
 * The inetlisteningserver510 state defines the different information that can be used
 * to evaluate the specified inet listening server.
 *
 * @author  Akihito Nakamura, AIST
 * @version $Id$
 * @see <a href="http://oval.mitre.org/language/">OVAL Language</a>
 */
public class InetListeningServers510State
    extends StateType
{
     ...
     * Constructor.
     */
    public InetListeningServers510State()
    {
        this( null, 0 );
    }
    ...
    {
        if (!(obj instanceof InetListeningServers510State)) {
            return false;
        }
    ...
    {
        return "inetlisteningservers510_state[" + super.toString()
