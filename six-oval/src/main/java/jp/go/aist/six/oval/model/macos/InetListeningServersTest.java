...
/**
 * This test's purpose is generally used to check if an application is listening on the network,
 ...
 *             Replaced by the inetlisteningservers510 test.
 */
@Deprecated
    ...
    extends TestType
{
     ...
     * Constructor.
     */
    public InetListeningServersTest()
    {
        this( null, 0 );
    }
    ...
    {
        if (!(obj instanceof InetListeningServersTest)) {
            return false;
        }
    ...
    {
        return "inetlisteningservers_test[" + super.toString() + "]";
    }
