...
/**
 * The user_sid_state enumerates the different groups (identified by SID)
 ...
 *             Replaced by the user_sid55 state and
    ...
    extends StateType
{
    ...
    {
        if (!(obj instanceof UserSidState)) {
            return false;
        }
    ...
    {
        return "user_sid_state[" + super.toString()
                        + ", user="         + getUser()
                        + ", enabled="      + getEnabled()
                        + ", group="        + getGroup()
             + "]";
