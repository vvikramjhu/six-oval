...
(
    ...
    ms_checksum_status  VARCHAR(16),
    version             VARCHAR(24),
    version_status      VARCHAR(16),
    type1               VARCHAR(24),
    type1_status        VARCHAR(16),
    development_class   VARCHAR(64),
    development_class_status    VARCHAR(16),
    company             VARCHAR(128),
    ...
    internal_name_status    VARCHAR(16),
    language            VARCHAR(16),
    language_status     VARCHAR(16),
    original_filename   VARCHAR(255),
    original_filename_status    VARCHAR(16),
