...
/**
 * The sid_sid object is used by a sid_sid_test to define the object set,
 * in this case a set of SIDs, to be evaluated.
 *
    ...
    extends SystemObjectType
{
    ...
    private SidSidBehaviors  behaviors;
    //{0..1}
...
//    }
    ...
    public void setBehaviors(
                    final SidSidBehaviors behaviors
                    )
    {
    ...
    {
        if (!(obj instanceof SidSidObject)) {
            return false;
        }
    ...
    {
        return "sid_sid_object[" + super.toString()
                        + ", set=" 			+ getSet()
