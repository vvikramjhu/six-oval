...
/**
 * The activedirectory57_state defines the different information that can be used
    ...
    extends StateType
{
    ...
    {
        if (!(obj instanceof ActiveDirectory57State)) {
            return false;
        }
    ...
    {
        return "activedirectory57_state[" + super.toString()
