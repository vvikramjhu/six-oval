 ...
 */
public abstract class AbstractRegistryAuthBehaviors
extends RegistryBehaviors
{
     ...
     * Constructor.
     */
    public AbstractRegistryAuthBehaviors()
    {
    }
    ...
    public static final Boolean includeGroup(
                    final AbstractRegistryAuthBehaviors obj
                    )
    {
                    ...
                    )
    {
        ...
        if (!(obj instanceof AbstractRegistryAuthBehaviors)) {
            return false;
        }

        if (super.equals( obj )) {
            AbstractRegistryAuthBehaviors  other = (AbstractRegistryAuthBehaviors)obj;
