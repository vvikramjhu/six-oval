...
/**
 * The line object is used by a line test to define the object to be evaluated.
 *
    ...
    extends SystemObjectType
{
    ...
    private EntityObjectStringType  show_subcommand;
    //{1..1}
    ...
    {
        return "line_object[" + super.toString()
                        + ", set="              + getSet()
