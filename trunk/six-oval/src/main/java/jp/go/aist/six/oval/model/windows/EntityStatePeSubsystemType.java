...
/**
 * The EntityStatePeSubsystemType identifies the valid subsystem types
    ...
    extends EntityStateStringType
{
     ...
     * Constructor.
     */
    public EntityStatePeSubsystemType()
    {
    }
...
//    }
    ...
    {
        if (content != null) {
            PeSubsystemEnumeration.fromValue( content );
        }
                    ...
                    )
    {
        ...
        if (!(obj instanceof EntityStatePeSubsystemType)) {
            return false;
        }
