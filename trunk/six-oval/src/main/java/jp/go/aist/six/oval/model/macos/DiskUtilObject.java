...
/**
 * The diskutil object is used by a diskutil_test to define the disks
 * to be verified on a Mac OS system.
 *
...
//    }
    ...
    {
        if (!(obj instanceof DiskUtilObject)) {
            return false;
        }
    ...
    {
        return "diskutil_object[" + super.toString()
                        + ", set="          + getSet()
                        + ", device="       + getDevice()
