...
/**
 * The accountinfo object is used by an accountinfo_test to define the object(s)
 * to be evaluated.
 *
...
//    }
    ...
    {
        if (!(obj instanceof AccountInfoObject)) {
            return false;
        }
    ...
    {
        return "accountinfo_object[" + super.toString()
                        + ", set"       + getSet()
