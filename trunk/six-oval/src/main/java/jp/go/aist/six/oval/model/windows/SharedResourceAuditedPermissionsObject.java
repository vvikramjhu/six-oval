    ...
    extends SystemObjectType
{
    ...
    private SharedResourceAuditedPermissionsBehaviors  behaviors;
    //{0..1}
     ...
     * Constructor.
     */
    public SharedResourceAuditedPermissionsObject()
    {
        this( null, 0 );
    }
...
//    }
    ...
    public void setBehaviors(
                    final SharedResourceAuditedPermissionsBehaviors behaviors
                    )
    {
    ...
    {
        if (!(obj instanceof SharedResourceAuditedPermissionsObject)) {
            return false;
        }
    ...
    {
        return "sharedresourceauditedpermissions_object[" + super.toString()
                        + ", set="          + getSet()
