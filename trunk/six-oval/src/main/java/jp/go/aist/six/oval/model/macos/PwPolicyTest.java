...
/**
 * This test pulls data from the 'pwpolicy -getpolicy' output.
 *
 * @author  Akihito Nakamura, AIST
 * @version $Id$
 * @see <a href="http://oval.mitre.org/language/">OVAL Language</a>
 * @deprecated Deprecated as of version 5.9:
 *             Replaced by the pwpolicy59 test and
    ...
    extends TestType
{
    ...
    {
        if (!(obj instanceof PwPolicyTest)) {
            return false;
        }
    ...
    {
        return "pwpolicy_test[" + super.toString() + "]";
    }
