...
/**
 * The shadow test is used to check information from the /etc/shadow file for a specific user.
 *
...
//        _oval_component_type = OvalComponentType.shadow;
    ...
    {
        return "shadow_test[" + super.toString() + "]";
    }
