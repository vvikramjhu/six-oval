 ...
 *             Replaced by the regkeyeffectiverights53 state and
    ...
    extends StateType
{
     ...
     * Constructor.
     */
    public RegkeyEffectiveRightsState()
    {
        this( null, 0 );
    }
...
//        _oval_component_type = OvalComponentType.regkeyeffectiverights;
    ...
    {
        if (!(obj instanceof RegkeyEffectiveRightsState)) {
            return false;
        }
    ...
    {
        return "regkeyeffectiverights_state[" + super.toString()
             + ", hive="                    + getHive()
             + ", key="                     + getKey()
