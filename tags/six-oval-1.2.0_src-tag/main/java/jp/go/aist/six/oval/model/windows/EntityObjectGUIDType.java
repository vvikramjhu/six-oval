...
/**
 * The EntityObjectGUIDType restricts a string value to a representation of a GUID, used for module ID.
 *
...
//    }
                    ...
                    )
    {
        ...
        if (!(obj instanceof EntityObjectGUIDType)) {
            return false;
        }
