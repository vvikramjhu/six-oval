...
/**
 * The EntityStateServiceTypeType defines the different values that are valid
 * for the service_type entity of a service.
 *
    ...
    extends EntityStateStringType
{
     ...
     * Constructor.
     */
    public EntityStateServiceTypeType()
    {
    }
...
//    }
                    ...
                    )
    {
        ...
        if (!(obj instanceof EntityStateServiceTypeType)) {
            return false;
        }
