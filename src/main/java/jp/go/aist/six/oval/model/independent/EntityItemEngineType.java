...
/**
 * The EntityItemEngineType defines a string entity value
 * that is restricted to an enumeration.
    ...
    extends EntityItemStringType
{
    ...
    public EntityItemEngineType(
                    final EngineEnumeration content
                    )
    {
                    ...
                    )
    {
        ...
        if (!(obj instanceof EntityItemEngineType)) {
            return false;
        }
