...
/**
 * The user_sid55 test is used to check information about Windows users.
 *
    ...
    extends TestType
{
    ...
    {
        if (!(obj instanceof UserSid55Test)) {
            return false;
        }
    ...
    {
        return "user_sid55_test[" + super.toString() + "]";
    }
