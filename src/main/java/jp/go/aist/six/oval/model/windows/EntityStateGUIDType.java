...
/**
 * The EntityStateGUIDType restricts a string value to a representation of a GUID, used for module ID.
 *
...
//    }
                    ...
                    )
    {
        ...
        if (!(obj instanceof EntityStateGUIDType)) {
            return false;
        }
