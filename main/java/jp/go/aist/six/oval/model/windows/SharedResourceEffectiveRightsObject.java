    ...
    extends SystemObjectType
{
    ...
    private SharedResourceEffectiveRightsBehaviors  behaviors;
    //{0..1}
     ...
     * Constructor.
     */
    public SharedResourceEffectiveRightsObject()
    {
        this( null, 0 );
    }
...
//    }
    ...
    public void setBehaviors(
                    final SharedResourceEffectiveRightsBehaviors behaviors
                    )
    {
    ...
    {
        if (!(obj instanceof SharedResourceEffectiveRightsObject)) {
            return false;
        }
    ...
    {
        return "sharedresourceeffectiverights_object[" + super.toString()
                        + ", set="          + getSet()
