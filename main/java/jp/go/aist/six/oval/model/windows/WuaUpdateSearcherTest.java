...
/**
 * The wuaupdatesearcher test is used to evaluate patch level in a Windows environment
 * utilizing the WUA (Windows Update Agent) interface.
 *
...
//        _oval_component_type = OvalComponentType.wuaupdatesearcher;
    ...
    {
        if (!(obj instanceof WuaUpdateSearcherTest)) {
            return false;
        }
    ...
    {
        return "wuaupdatesearcher_test[" + super.toString() + "]";
    }
